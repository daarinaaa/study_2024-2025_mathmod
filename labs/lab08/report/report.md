...
$$M_0^1=5.4, \, M_0^2=5.1,\\ p_{cr}=27, \,N=30, q=1\\ \tau_1=8, \, \tau_2=9,\\ \tilde{p_1}=13, \, \tilde{p_2}=10.1$$
...
tau2 = 9 #длительность производственного цикла фирмы 2
p2 = 10.1 #себестоимость продукта у фирмы 2
...
u0 = [5.4, 5.1] #начальные значения M1 и M2
p = [a1, a2, b, c1, c2]
...
```
  ...
  parameter Real tau1 = 8;  
  parameter Real p1 = 13;
  parameter Real tau2 = 9;
  parameter Real p2 = 10.1;  
  parameter Real N = 30;
  parameter Real q = 1;
